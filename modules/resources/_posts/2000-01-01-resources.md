...
## General Statistical Thinking & Foundations
- **StatQuest (Josh Starmer).** *Statistical Concepts Explained Simply.*  
  <https://statquest.org/>
- **ASA Statement on Statistical Inference and p-values.**  
...
- **Controls in Experiments (Editorial).**  
  <https://doi.org/10.1038/nmeth.1655>
...
- **StatQuest – Model Selection.**  
  <https://statquest.org>

## Assumptions & Diagnostics
- **UCLA – Checking Linear Model Assumptions.**  
  <https://stats.idre.ucla.edu/other/mult-pkg/whatstat/linear-assumptions/>

## Effect Sizes, CIs, Interpretation
- **Cumming (2014).** *Effect sizes & CIs.*  
  <https://doi.org/10.1177/0956797613504966>
- **Nature – Statistical errors & significance.**  
...
- **Software Carpentry – Reproducible Data Science.**  
